...
const append = (item: unknown) => ({ ops: [{ op: 'append', item }] });
      ...
      ops: [
        {
          op: 'update',
          key: 't1',
          item: { kind: 'text', text: 'a ', streaming: true },
        },
      ],
    });
      ...
      ops: [
        {
          op: 'update',
          key: 't1',
          item: { kind: 'text', text: 'a b', streaming: true },
        },
      ],
    });
      ...
      ops: [
        {
          op: 'update',
          key: 't1',
          item: { kind: 'text', text: 'a b', streaming: false },
        },
      ],
    });
    expect(
